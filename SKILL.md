---
name: ipo-annual-report-updater
license: MIT
metadata:
  version: "1.0.0"
...
description: >
  ...
  系统性地将IPO底稿从旧报告期迁移至新年度口径，涵盖：
  申报底稿、问询反馈底稿、股东信息核查底稿、证监会离职人员核查底稿、内核文件等全套材料。
  支持文件同步替换、目录状态标注、DOCX内容批量修改、残留旧件审计等核心操作。
  当用户提到"年报更新"、"底稿迁移"、"替换旧底稿"、"更新申报材料"、"IPO材料换期"、
  "补充法律意见书更新"、"内核文件修改"时触发。
triggers:
  - 年报更新
  - 底稿迁移
  - 替换底稿
